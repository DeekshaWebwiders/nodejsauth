...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.email || !formData.password || !formData.confirmPassword || !formData.mobile || !formData.gender || !formData.profilePicture) {
              ...
              <div className="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
                ...
                <div className="flex-auto p-6">
                  <form role="form text-left" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                      <input type="file" accept="image/*" name="profilePicture" accept="image/*" onChange={handleChange} className="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" />
                    </div>
